...
tags: ["Neuroscience", "AI", "Information Theory", "Learning", "Memory"]
---

<div style="margin-top: 10px; margin-bottom: 10px; text-align: left;">
  <a href="https://medium.com/@ahmadrazacdx/a-synthesis-of-biological-and-computational-learning-789b97caaea4" target="_blank" style="background-color: white; color: black; padding: 5px 15px; text-decoration: none; border-radius: 7px; font-weight: bold; border: 1px solid #ccc;">
...
<figure style="text-align:center;">
  <img src="/posts/1/ltp.svg" width="440" height="auto" alt="LTP"> 
  <figcaption style="color: #555; margin-top: 1px;"> <strong>Figure 1.</strong> Visual representation of synaptic strengthening. (Source: Author) 
  </figcaption> 
</figure>
...
<figure style="text-align:center;"> 
  <img src="/posts/1/stdp.svg" width="400" height="auto" alt="STDP"> 
  <figcaption style="color: #555; margin-top: 1px;"> <strong>Figure 2.</strong> Spike-timing-dependent plasticity (STDP). If the presynaptic spike occurs before the postsynaptic spike (pre before post), the synapse is strengthened (LTP, long-term potentiation). If the postsynaptic spike occurs before the presynaptic spike, the synapses are weakened (LTD, long-term depression). (Source: Author) 
  </figcaption> 
</figure>
...
<figure style="text-align:center;"> 
  <img src="/posts/1/mc-neuron.svg" width="400" height="auto" alt="WM-Neuron"> 
  <figcaption style="color: #555; margin-top: 1px;"> <strong>Figure 3.</strong> A schematic of the first mathematical model of a neuron. (Source: Author) 
  </figcaption> 
</figure>
...
<figure style="text-align:center;"> 
  <img src="/posts/1/bio-vs-art.svg" width="580" height="auto" alt="Bio-vs-AI-Neuron"> 
  <figcaption style="color: #555; margin-top: 1px;"> <strong>Figure 4.</strong> An illustration of biological vs artificial neuron. (Source: Author) 
  </figcaption> 
</figure>
...
<figure style="text-align:center;"> 
  <img src="/posts/1/self_attn.svg" width="540" height="auto" alt="Self Attention"> 
  <figcaption style="color: #555; margin-top: 1px;"> <strong>Figure 5.</strong> An illustration of Self-Attention Mechanism. (Source: Author) 
  </figcaption> 
</figure>
...
You practiced hard today. You feel like you've improved. But here's the truth: the improvement isn't consolidated until you sleep. During slow-wave sleep, the hippocampus "replays" the day's learning at accelerated speed, transferring information to long-term storage in the neocortex (Stickgold, 2005).

If you pull an all-nighter after learning something, the memory trace can physically dissolve. You don't just forget; the learning evaporates as if it never happened. You cannot cram your way to lasting knowledge. Sleep is not optional; it is part of the learning process itself.
...
Bi, G., & Poo, M. (1998). [Synaptic modifications in cultured hippocampal neurons: Dependence on spike timing, synaptic strength, and postsynaptic cell type](https://doi.org/10.1523/JNEUROSCI.18-24-10464.1998). _Journal of Neuroscience_, 18(24), 10464–10472.

Bliss, T. V. P., & Lomo, T. (1973). [Long-lasting potentiation of synaptic transmission in the dentate area of the anaesthetized rabbit following stimulation of the perforant path](https://doi.org/10.1113/jphysiol.1973.sp010273). _The Journal of Physiology_, 232(2), 331–356.

Boldrini, M., Fulmore, C. A., Tartt, A. N., Simeon, L. R., Pavlova, I., Poposka, V., ... & Mann, J. J. (2018). [Human hippocampal neurogenesis persists throughout aging](https://doi.org/10.1016/j.stem.2018.03.015). _Cell Stem Cell_, 22(4), 589–599.

Brown, T. B., Mann, B., Ryder, N., Subbiah, M., Kaplan, J., Dhariwal, P., ... & Amodei, D. (2020). [Language models are few-shot learners](https://proceedings.neurips.cc/paper/2020/hash/1457c0d6bfcb4967418bfb8ac142f64a-Abstract.html). _Advances in Neural Information Processing Systems_, 33, 1877–1901.

Desimone, R., & Duncan, J. (1995). [Neural mechanisms of selective visual attention](https://doi.org/10.1146/annurev.ne.18.030195.001205). _Annual Review of Neuroscience_, 18, 193–222.

Eriksson, P. S., Perfilieva, E., Bjork-Eriksson, T., Alborn, A. M., Nordborg, C., Peterson, D. A., & Gage, F. H. (1998). [Neurogenesis in the adult human hippocampus](https://doi.org/10.1038/3305). _Nature Medicine_, 4(11), 1313–1317.

Fiorella, L., & Mayer, R. E. (2013). [The relative benefits of learning by teaching and teaching expectancy](https://doi.org/10.1016/j.cedpsych.2013.06.001). _Contemporary Educational Psychology_, 38(4), 281–288.

Gazzaniga, M. S., & LeDoux, J. E. (1978). [The Integrated Mind](https://www.amazon.com/Integrated-Mind-Michael-S-Gazzaniga/dp/0306400322). Plenum Press.

Gruber, M. J., Gelman, B. D., & Ranganath, C. (2014). [States of curiosity modulate hippocampus-dependent learning via the dopaminergic circuit](https://doi.org/10.1016/j.neuron.2014.08.060). _Neuron_, 84(2), 486–496.

Haier, R. J., Siegel, B. V., Nuechterlein, K. H., Hazlett, E., Wu, J. C., Paek, J., ... & Buchsbaum, M. S. (1988). [Cortical glucose metabolic rate correlates of abstract reasoning and attention studied with positron emission tomography](https://doi.org/10.1016/0160-2896(88)90016-5). _Intelligence_, 12(2), 199–217.

Hebb, D. O. (1949). [The Organization of Behavior: A Neuropsychological Theory](https://www.amazon.com/Organization-Behavior-Neuropsychological-Theory-Classics/dp/0471381653). Wiley & Sons.

Ito, M., & Kano, M. (1982). [Long-lasting depression of parallel fiber-Purkinje cell transmission induced by conjunctive stimulation of parallel fibers and climbing fibers in the cerebellar cortex](https://doi.org/10.1016/0304-3940(82)90380-9). _Neuroscience Letters_, 33(3), 253–258.

Kornell, N., & Bjork, R. A. (2008). [Learning concepts and categories: Is spacing the "enemy of induction"?](https://doi.org/10.1111/j.1467-9280.2008.02127.x) _Psychological Science_, 19(6), 585–592.

Markram, H., Lübke, J., Frotscher, M., & Sakmann, B. (1997). [Regulation of synaptic efficacy by coincidence of postsynaptic APs and EPSPs](https://doi.org/10.1126/science.275.5297.213). _Science_, 275(5297), 213–215.

McCulloch, W. S., & Pitts, W. (1943). [A logical calculus of the ideas immanent in nervous activity](https://doi.org/10.1007/BF02478259). _Bulletin of Mathematical Biophysics_, 5, 115–133.

Miller, E. K., & Cohen, J. D. (2001). [An integrative theory of prefrontal cortex function](https://doi.org/10.1146/annurev.neuro.24.1.167). _Annual Review of Neuroscience_, 24, 167–202.

Minsky, M., & Papert, S. (1969). [Perceptrons: An Introduction to Computational Geometry](https://www.amazon.com/Perceptrons-Introduction-Computational-Geometry-Classics/dp/0262514217). MIT Press.

Nader, K., Schafe, G. E., & LeDoux, J. E. (2000). [Fear memories require protein synthesis in the amygdala for reconsolidation after retrieval](https://doi.org/10.1038/35021052). _Nature_, 406(6797), 722–726.

Raichle, M. E., MacLeod, A. M., Snyder, A. Z., Powers, W. J., Gusnard, D. A., & Shulman, G. L. (2001). [A default mode of brain function](https://doi.org/10.1073/pnas.98.2.676). _Proceedings of the National Academy of Sciences_, 98(2), 676–682.

Rosenblatt, F. (1958). [The perceptron: A probabilistic model for information storage and organization in the brain](https://doi.org/10.1037/h0042519). _Psychological Review_, 65(6), 386–408.

Rumelhart, D. E., Hinton, G. E., & Williams, R. J. (1986). [Learning representations by back-propagating errors](https://doi.org/10.1038/323533a0). _Nature_, 323(6088), 533–536.

Shors, T. J., Anderson, M. L., Curlik, D. M., & Nokia, M. S. (2012). [Use it or lose it: How neurogenesis keeps the brain fit for learning](https://doi.org/10.1016/j.bbr.2011.04.023). _Behavioural Brain Research_, 227(2), 450–458.

Sorrells, S. F., Paredes, M. F., Cebrian-Silla, A., Sandoval, K., Qi, D., Kelley, K. W., ... & Bhattacharya, N. (2018). [Human hippocampal neurogenesis drops sharply in children to undetectable levels in adults](https://doi.org/10.1038/nature25975). _Nature_, 555(7696), 377–381.

Stickgold, R. (2005). [Sleep-dependent memory consolidation](https://doi.org/10.1038/nature04286). _Nature_, 437(7063), 1272–1278.

Tashiro, A., Makino, H., & Gage, F. H. (2007). [Experience-specific functional modification of the dentate gyrus through adult neurogenesis: A critical period during an immature stage](https://doi.org/10.1523/JNEUROSCI.4970-06.2007). _Journal of Neuroscience_, 27(12), 3252–3259.

Tishby, N., Pereira, F. C., & Bialek, W. (1999). [The information bottleneck method](https://arxiv.org/abs/physics/9907071). In _Proceedings of the 37th Annual Allerton Conference on Communication, Control, and Computing_ (pp. 368–377).

Vaswani, A., Shazeer, N., Parmar, N., Uszkoreit, J., Jones, L., Gomez, A. N., ... & Polosukhin, I. (2017). [Attention is all you need](https://proceedings.neurips.cc/paper/2017/hash/3f5ee243547dee91fbd053c1c4a845aa-Abstract.html). _Advances in Neural Information Processing Systems_, 30, 5998–6008.
